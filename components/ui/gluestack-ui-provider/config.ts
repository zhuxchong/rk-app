...
export const config = {
  light: vars({
    /* Brand Colours - Mode 1 */
    '--brand-label-help': '52 152 219',
    '--brand-label-red-danger': '231 76 60',
    '--brand-label-green-success': '39 174 96',
    '--brand-label-amber-warning': '243 156 18',
    '--brand-text-1': '34 34 34',
    '--brand-text-2': '68 68 68',
    '--brand-text-3': '255 255 255',
    '--brand-text-4': '85 85 85',
    '--brand-text-placeholder': '149 149 149',
    '--brand-text-disable': '203 203 203',
    '--brand-text-border': '224 224 224',
    '--brand-cta-1': '255 184 0',
    '--brand-cta-hovered-1': '230 166 0',
    '--brand-background-1': '34 34 34',
    '--brand-background-2': '68 68 68',
    '--brand-background-3': '0 0 0',
    '--brand-cta-price': '26 219 207',
    '--brand-cta-price-hovered': '5 183 172',
    '--brand-transparent-black': '0 0 0',
    '--brand-input-field-on-text-2': '85 85 85',
    '--brand-label-reward': '255 105 180',
